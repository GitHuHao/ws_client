 ...
 * 
 */
@WebServiceClient(name = "BookServiceImplService", targetNamespace = "http://service.ws.atguigu.com/", wsdlLocation = "http://127.0.0.1:8080/ws_service/ws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICEIMPLSERVICE_QNAME = new QName("http://service.ws.atguigu.com/", "BookServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/ws_service/ws?wsdl");
            url = new URL("http://localhost:8080/ws_service/BookService_WS?wsdl");
    ...
    public BookService getBookServiceImplPort() {
        return super.getPort(new QName("http://service.ws.atguigu.com/", "BookServiceImplPort"), BookService.class);
    }
    ...
    public BookService getBookServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.atguigu.com/", "BookServiceImplPort"), BookService.class, features);
    }
